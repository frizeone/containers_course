...
function LMSIsInitialized()
{
   ...
   if (api == null)
   {
        console.log("Unable to locate the LMS's API Implementation. LMSIsInitialized() failed.");
...
function ErrorHandler()
{
   ...
   if (api == null)
   {
        console.log("Unable to locate the LMS's API Implementation. Cannot determine LMS error code.");
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
        console.log("Не найден API адаптер СДО.");
        //alert("Unable to find an API adapter");
   }
    if (theAPI != null)
    {
        console.log("API адаптер СДО найден.");
    }
   return theAPI
}
