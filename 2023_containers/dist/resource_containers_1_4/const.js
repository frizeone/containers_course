 ...
 */
var gnMaxPages = 27; // число слайдов в разделе
angular.module('course').value('razdelName', 'Контейнерные терминалы');
angular.module('course').value('sectionName', '');
angular.module('course').value('pageCount', gnMaxPages);
var SdanoFlag = true;

var InteractionFlag = [12 ,16]; // указание слайдов с интерактивностями
