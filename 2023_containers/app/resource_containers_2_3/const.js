 ...
 */
var gnMaxPages = 25; // число слайдов в разделе
angular.module('course').value('razdelName', 'Мультимодальные перевозки грузов');
angular.module('course').value('sectionName', '');
angular.module('course').value('pageCount', gnMaxPages);
var SdanoFlag = true;

var InteractionFlag = [2 ,19, ]; // указание слайдов с интерактивностями
